...
[휴리스틱](https://ko.wikipedia.org/wiki/%ED%9C%B4%EB%A6%AC%EC%8A%A4%ED%8B%B1_%EC%9D%B4%EB%A1%A0) 알고리즘을 활용해서 **O(n)** 시간 복잡도를 갖게되는 `Reconciliaion` 알고리즘을 구현했습니다.
...
<Image size="small" src="/posts/2022/04/react-reconciliation/lbl.png" />
